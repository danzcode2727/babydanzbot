...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp DANZ
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo Danz
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig zidan.amd27
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & Danz
➸ *${prefix}play*
...
➸ *${prefix}hartatahta*
Membuat lomgo, contoh : ${prefix}hartatahta Ella
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub Danz & Hub
